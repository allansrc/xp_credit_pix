...
abstract class XPeither<TFailure, TSuccess> {
  final TFailure? _failure;
  final TSuccess? _success;
  XPeither({TFailure? failure, TSuccess? success})
      : _failure = failure,
        _success = success,
...
class SuccessResponse<TFailure, TSuccess> extends XPeither<TFailure, TSuccess> {
  SuccessResponse(TSuccess value) : super(success: value);
}

class FailureResponse<TFailure, TSuccess> extends XPeither<TFailure, TSuccess> {
